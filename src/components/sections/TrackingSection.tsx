...
export function TrackingSection() {
  ...
  return (
    <div ref={containerRef} className="py-16 md:py-0 md:h-screen w-full flex flex-col items-start justify-center pl-6 pr-4 md:pl-[15%] pointer-events-auto text-left">
